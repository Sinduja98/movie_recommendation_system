...
$(function(){
  ...
  const inputHandler = function(e){
    ...
    if (e.target.value==""){
      $('.movie-button').attr('diabled',true);
    }
    else{
  ...
  $.ajax({
    ...
    success: function(movie){
      if(!isQuerySearch){
        ...
        get_movie_data(movie_id,my_api_key,movie_title,movie_title_org);
      }
...
function get_movie_data(movie_id,my_api_key,movie_title,movie_title_org){
  $.ajax({
    type:'GET',
...
function show_details(movie_details,movie_title,my_api_key,movie_id){
  ...
  movie_cast=get_movie_casts(movie_id,my_api_key);

  ind_cast=get_individual_casts(movie_cast,my_api_key);
...
function get_individual_casts(movie_cast,my_api_key){
  cast_bdays=[];
  cast_bios=[];
  cast_places=[];
...
function get_movie_casts(movie_id,my_api_key){
  cast_ids=[];
  cast_names=[];
  cast_chars=[];
  cast_profiles=[];
